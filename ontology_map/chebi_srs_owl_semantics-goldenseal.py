...
if __name__ == "__main__":
	...
	graph.add((URIRef(urn_dict['Goldenseal']), RDFS_NS.type, OWL_NS.Class))
	...
	graph.add((URIRef(urn_dict['Hydrastis_canadensis_whole']), RDFS_NS.type, OWL_NS.Class))
	...
	graph.add((URIRef(urn_dict['7-hydroxy-mitragynine']), RDF_NS.type, OWL_NS.Class))
